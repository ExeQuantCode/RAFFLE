...
subroutine f90wrap_raffle__dc__generate_fingerprint_atom_python__dc_type( &
    ...
    this_ptr = transfer(this, this_ptr)
    structure_ptr = transfer(structure, structure_ptr)
    call this_ptr%p%generate_fingerprint_atom_python( &
        structure=structure_ptr%p, atom_index=atom_index, &
        output_2body=output_2body, output_3body=output_3body, &
        output_4body=output_4body &
    )
end subroutine f90wrap_raffle__dc__generate_fingerprint_atom_python__dc_type
...
subroutine f90wrap_raffle__dc__add_fingerprint_python__dc_type( &
    ...
    type(distribs_container_type_ptr_type) :: this_ptr
    integer, intent(in), dimension(2) :: this
    character(3), dimension(n0), intent(in) :: element_symbols
    integer, dimension(n0), intent(in) :: stoichiometry
    integer :: n0
    !f2py intent(hide), depend(element_symbols) :: n0 = shape(element_symbols,0)
    real(4), intent(in) :: energy
    integer :: n1
    !f2py intent(hide), depend(df_2body) :: n1 = shape(df_2body,0)
    integer :: n2
    !f2py intent(hide), depend(df_2body) :: n2 = shape(df_2body,1)
    real(4), intent(in), dimension(n1,n2) :: df_2body
    integer :: n3
    !f2py intent(hide), depend(df_3body) :: n3 = shape(df_3body,0)
    integer :: n4
    !f2py intent(hide), depend(df_3body) :: n4 = shape(df_3body,1)
    real(4), intent(in), dimension(n3,n4) :: df_3body
    integer :: n5
    !f2py intent(hide), depend(df_4body) :: n5 = shape(df_4body,0)
    integer :: n6
