! Module atomstruc defined in file ../src/lib/mod_geom_rw.f90
...
subroutine f90wrap_geom_rw__get__igeom_input(f90wrap_igeom_input)
    use atomstruc, only: atomstruc_igeom_input => igeom_input
    implicit none
    integer, intent(out) :: f90wrap_igeom_input

    f90wrap_igeom_input = atomstruc_igeom_input
...
subroutine f90wrap_geom_rw__set__igeom_output(f90wrap_igeom_output)
    ...
    atomstruc_igeom_output = f90wrap_igeom_output
end subroutine f90wrap_geom_rw__set__igeom_output

! End of module atomstruc defined in file ../src/lib/mod_geom_rw.f90
