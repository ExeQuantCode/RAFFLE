! Module raffle__gnn_fingerprint_multihead defined in file ../src/lib/mod_gnn_fingerprint_multihead.f90
...
subroutine f90wrap_gnn_fingerprint_type__get__fingerprint_dim_2body( &
	 this, f90wrap_fingerprint_dim_2body)
	use raffle__gnn_fingerprint_multihead, only: gnn_fingerprint_type
	implicit none
	type gnn_fingerprint_type_ptr_type
		type(gnn_fingerprint_type), pointer :: p => NULL()
	...
	integer, intent(in) :: this(2)
	type(gnn_fingerprint_type_ptr_type) :: this_ptr
	integer, intent(out) :: f90wrap_fingerprint_dim_2body
	this_ptr = transfer(this, this_ptr)
	f90wrap_fingerprint_dim_2body = this_ptr%p%fingerprint_dim_2body
end subroutine f90wrap_gnn_fingerprint_type__get__fingerprint_dim_2body

subroutine f90wrap_gnn_fingerprint_type__get__fingerprint_dim_3body( &
	 this, f90wrap_fingerprint_dim_3body)
	use raffle__gnn_fingerprint_multihead, only: gnn_fingerprint_type
	implicit none
	type gnn_fingerprint_type_ptr_type
		type(gnn_fingerprint_type), pointer :: p => NULL()
	...
	integer, intent(in) :: this(2)
	type(gnn_fingerprint_type_ptr_type) :: this_ptr
	integer, intent(out) :: f90wrap_fingerprint_dim_3body
	this_ptr = transfer(this, this_ptr)
	f90wrap_fingerprint_dim_3body = this_ptr%p%fingerprint_dim_3body
end subroutine f90wrap_gnn_fingerprint_type__get__fingerprint_dim_3body

subroutine f90wrap_gnn_fingerprint_type__get__fingerprint_dim_4body( &
	 this, f90wrap_fingerprint_dim_4body)
	use raffle__gnn_fingerprint_multihead, only: gnn_fingerprint_type
	implicit none
	type gnn_fingerprint_type_ptr_type
		type(gnn_fingerprint_type), pointer :: p => NULL()
	...
	integer, intent(in) :: this(2)
	type(gnn_fingerprint_type_ptr_type) :: this_ptr
	integer, intent(out) :: f90wrap_fingerprint_dim_4body
	this_ptr = transfer(this, this_ptr)
	f90wrap_fingerprint_dim_4body = this_ptr%p%fingerprint_dim_4body
end subroutine f90wrap_gnn_fingerprint_type__get__fingerprint_dim_4body
...
subroutine f90wrap_gnn_fingerprint_type__get__layer_type( &
	 this, f90wrap_layer_type)
	use raffle__gnn_fingerprint_multihead, only: gnn_fingerprint_type
	implicit none
	type gnn_fingerprint_type_ptr_type
		type(gnn_fingerprint_type), pointer :: p => NULL()
	...
	integer, intent(in) :: this(2)
	type(gnn_fingerprint_type_ptr_type) :: this_ptr
	integer, intent(out) :: f90wrap_layer_type
	this_ptr = transfer(this, this_ptr)
	f90wrap_layer_type = this_ptr%p%layer_type
end subroutine f90wrap_gnn_fingerprint_type__get__layer_type
...
!###############################################################################
subroutine f90wrap_gnn_fingerprint_type__compute_fingerprint_components( &
	 this, basis, fingerprint_2body, fp_dim_2body, fingerprint_3body, &
	...
	real(real32), dimension(fp_dim_2body), intent(out) :: fingerprint_2body
	real(real32), dimension(fp_dim_3body), intent(out) :: fingerprint_3body
	real(real32), dimension(fp_dim_4body), intent(out) :: fingerprint_4body
	type(gnn_fingerprint_type_ptr_type) :: this_ptr
	type(basis_type_ptr_type) :: basis_ptr
	...
	call this_ptr%p%compute_fingerprint_components( &
		 basis_ptr%p, fingerprint_2body, fingerprint_3body, fingerprint_4body)
end subroutine f90wrap_gnn_fingerprint_type__compute_fingerprint_components
...
! Compute gradients
!###############################################################################
subroutine f90wrap_gnn_fingerprint_type__compute_gradients( &
	 this, basis, grad_2body, fp_dim_2body, grad_3body, fp_dim_3body, &
	 grad_4body, fp_dim_4body, n_atoms)
	use raffle__constants, only: real32
	use raffle__gnn_fingerprint_multihead, only: gnn_fingerprint_type
	use raffle__geom_rw, only: basis_type
	implicit none
	...
	integer, intent(in) :: this(2)
	integer, intent(in) :: basis(2)
	integer, intent(in) :: fp_dim_2body, fp_dim_3body, fp_dim_4body, n_atoms
	real(real32), dimension(fp_dim_2body, n_atoms, 3), intent(out) :: grad_2body
	real(real32), dimension(fp_dim_3body, n_atoms, 3), intent(out) :: grad_3body
	real(real32), dimension(fp_dim_4body, n_atoms, 3), intent(out) :: grad_4body
	type(gnn_fingerprint_type_ptr_type) :: this_ptr
	type(basis_type_ptr_type) :: basis_ptr

	this_ptr = transfer(this, this_ptr)
	basis_ptr = transfer(basis, basis_ptr)
	call this_ptr%p%compute_gradients( &
		 basis_ptr%p, grad_2body, grad_3body, grad_4body)
end subroutine f90wrap_gnn_fingerprint_type__compute_gradients
...
subroutine f90wrap_gnn_fingerprint_type__inverse_design( &
	 ...
	 num_steps, step_size, verbose, use_predict)
	use raffle__constants, only: real32
	use raffle__gnn_fingerprint_multihead, only: gnn_fingerprint_type
	use raffle__geom_rw, only: basis_type
	implicit none
