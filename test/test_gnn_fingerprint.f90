program test_gnn_fingerprint
  ...
  call assert(gnn%num_vertex_features == 4, &
       'GNN num_vertex_features should be 4 (3 coords + 1 species)', success)
  ...
  call assert(graph1%num_vertex_features == 4, &
       'Graph vertex features should be 4', success)
